#ifndef OGN_DOWN_CONV_LAYER_HPP_
#define OGN_DOWN_CONV_LAYER_HPP_
...
class OGNDownConvLayer : public OGNLayer<Dtype> {
 public:
  explicit OGNDownConvLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "OGNDownConv"; }
 ...
 protected:
  ...
  vector<set<KeyType> > _next_level_keys;
...
#endif  // OGN_DOWN_CONV_LAYER_HPP_
